...
Runner.prototype.create = function (callback) {
    ...
    this.client.createContainer(createOpts, function (err, container) {
        ...
        container.attach(attachOpts, function (err, stream) {
            ...
            stdout.on('data', function(data) { self.addOuput('stdout', data); });
            stderr.on('data', function(data) { self.addOuput('stderr', data); });
...
Runner.prototype.addOuput = function(stream, chunk) {
