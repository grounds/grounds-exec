...
var ErrorInvalidEndpoint         = new Error('Please specify a valid Docker endpoint.'),
    ...
    ErrorMissingAPINotResponding = new Error('Docker API not responding.');
...
function validate(args, callback) {
    ...
    client.ping(function (err) {
        if (err) return callback(null, ErrorMissingAPINotResponding);
...
module.exports = {
    ...
    ErrorMissingAPINotResponding: ErrorMissingAPINotResponding,
    validate: validate,
    getClient: getClient,
